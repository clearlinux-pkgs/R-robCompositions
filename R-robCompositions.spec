...
Source0  : https://cran.r-project.org/src/contrib/robCompositions_2.4.1.tar.gz
...
%prep
%setup -q -n robCompositions
pushd ..
cp -a robCompositions buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693256734
